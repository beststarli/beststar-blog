...
tags: [技术]
keywords: [博客, 技术原理]
image: https://img.beststarli.cn/blog/tech/blog/myblog.png
---
...
<!-- truncate -->
![blog](https://img.beststarli.cn/blog/tech/blog/myblog.png)
...
![Docusaurus](https://img.beststarli.cn/blog/tech/blog/docusaurus.png)
...
npm run start
```
![初始化](https://img.beststarli.cn/blog/tech/blog/init.png)
>这就是初始化后的博客
...
![iconify](https://img.beststarli.cn/blog/tech/blog/iconify.png)
![simple icon](https://img.beststarli.cn/blog/tech/blog/simpleicon.png)

插图主要来着于[unDraw](https://undraw.co/illustrations)
![unDraw](https://img.beststarli.cn/blog/tech/blog/undraw.png)
...
![new repo](https://img.beststarli.cn/blog/tech/blog/newrepo.png)
...
![vercel1](https://img.beststarli.cn/blog/tech/blog/vercel1.png)
> 第一步：在`Projects`界面点击`Add New...`菜单中的`Project`选项。

![vercel2](https://img.beststarli.cn/blog/tech/blog/vercel2.png)
> 第二步：在`Import Git Repository`版块找到要部署的Repository并点击`Import`按钮。

![vercel3](https://img.beststarli.cn/blog/tech/blog/vercel3.png)
> 第三步：可直接点击`Deploy`按钮完成部署，也可在以上更改相关配置。

![vercel4](https://img.beststarli.cn/blog/tech/blog/vercel4.png)
> 第四步：看到这个页面就代表部署完成了，可以点击`Continue to Dashboard`来监看部署后博客网站的信息。

![vercel5](https://img.beststarli.cn/blog/tech/blog/vercel5.png)
> 完成部署
...
![yun1](https://img.beststarli.cn/blog/tech/blog/yun1.png)
> 第一步：在概览界面查询域名，在此输入想要购买的域名并点击`查询域名`按钮

![yun2](https://img.beststarli.cn/blog/tech/blog/yun2.png)
> 第二步：选择合适的域名，点击相应域名的`立即加购`按钮添加购物车，可按需要为域名添加套餐，点击`立即购买`按钮跳转域名注册界面。

![yun3](https://img.beststarli.cn/blog/tech/blog/yun3.png)
> 第三步：按需要为域名配置购买信息，第一次购买需创建信息模板，信息模板的审核平台提示需1-3天，本人实际操作下来个人用户只审核了不到一个小时就通过了。勾选页面下方`同意协议`选项，点击`提交订单`进行支付。

![yun4](https://img.beststarli.cn/blog/tech/blog/yun4.png)
...
![cf1](https://img.beststarli.cn/blog/tech/blog/cf1.png)
> 第一步：在`账户主页`界面，点击`加入域`按钮

![cf2](https://img.beststarli.cn/blog/tech/blog/cf2.png)
> 第二步：填入我们刚刚购买的域名，直接点击`继续`按钮

![cf3](https://img.beststarli.cn/blog/tech/blog/cf3.png)
> 第三步：为域名选择计划，选择`Free`即可。

![cf4](https://img.beststarli.cn/blog/tech/blog/cf4.png)
> 第四步：在接下来的页面，我们拿到了Cloudflare生成的两条DNS，至此Cloudflare的工作暂告一段落。

回到腾讯云控制台，更改DNS服务器解析。

![yun5](https://img.beststarli.cn/blog/tech/blog/yun5.png)
> 第五步：点击购买域名`操作`一栏的`管理`按钮，进入域名管理页面

![yun6](https://img.beststarli.cn/blog/tech/blog/yun6.png)
> 第六步：点击`修改DNS服务器`按钮

![yun7](https://img.beststarli.cn/blog/tech/blog/yun7.png)
...
![cf5](https://img.beststarli.cn/blog/tech/blog/cf5.png)
> 第一步：在Cloudflare控制台在我们域名后的`更多`菜单点击`配置DNS`选项

![cf6](https://img.beststarli.cn/blog/tech/blog/cf6.png)
...
![vercel6](https://img.beststarli.cn/blog/tech/blog/vercel6.png)
> 第三步：在`DashBoard`界面，点击`Domains`按钮。

![vercel7](https://img.beststarli.cn/blog/tech/blog/vercel7.png)
> 第四步：在`Domains`界面，点击`Add Domain`按钮。

![vercel8](https://img.beststarli.cn/blog/tech/blog/vercel8.png)
![vercel9](https://img.beststarli.cn/blog/tech/blog/vercel9.png)
