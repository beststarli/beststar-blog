...
## 后续完成的工作
### 文档栏目
在博客的顶部导航栏中，我添加了一个`文档`栏目，来存放一些系统化的技术文档和教程，这些文档是我在工作中积累的一些经验总结，或者是一些技术难点的解决方案，或者是一些工具的使用教程等等。通过这个栏目，我希望能够将这些零散的知识点进行系统化的整理和分享，让更多的人能够受益。

### 主页文档卡片
在博客的主页上，我添加了文档分类卡片，来展示一些最新的文档，这些文档卡片可以通过点击进入对应的文档页面，方便用户快速找到自己感兴趣的内容。

### 搜索栏
在博客的顶部导航栏中，我添加了一个搜索栏，来提供全局搜索功能，用户可以通过这个搜索栏来搜索博客中的内容，包括文档、博客文章、项目等等，这样用户就可以更快速地找到自己需要的信息。

### 显示调整
- 优化了移动端侧边栏展开显示不完全的问题。
- 优化了博客归档中文章标题显示超出容器宽度的问题。

### 图片加载优化
由原有的项目目录静态图片资源解析加载，改为使用腾讯云对象存储COS来存储和加载图片资源，通过CDN加速域名并配置了自定义源站域名，将COS存储桶与PicGo联接实现图片快速上传图床。这样可以提高图片的加载速度和稳定性，同时也可以节省服务器的存储空间。

### 工信部与公安联网备案
根据国家相关法规，个人博客需要进行工信部备案，并在工信部完成备案30天内与公安联网备案，才能合法运营，确保博客的合法性和安全性。目前备案流程已经完成，博客正式上线运营了。
