...
description: Learn how to enable and use Vercel Speed Insights on your project
sidebar_position: 1
---
...
For most frameworks (Next.js, Next.js App Router, SvelteKit, Remix, Create React App, Nuxt, Vue, Other, Astro):
